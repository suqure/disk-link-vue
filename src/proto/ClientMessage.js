export function encodeClientBody(message) {
  let bb = popByteBuffer();
  _encodeClientBody(message, bb);
  return toUint8Array(bb);
}

function _encodeClientBody(message, bb) {
...
export function decodeClientBody(binary) {
  return _decodeClientBody(wrapByteBuffer(binary));
}

function _decodeClientBody(bb) {
  let message = {};
...
function _encodeClientMessage(message, bb) {
  ...
  if (array$body !== undefined) {
    for (let value of array$body) {
      ...
      _encodeClientBody(value, nested);
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 6: {
        ...
        values.push(_decodeClientBody(bb));
        bb.limit = limit;
        break;
      }
