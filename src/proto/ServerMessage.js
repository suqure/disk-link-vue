export function encodeServerBody(message) {
  let bb = popByteBuffer();
  _encodeServerBody(message, bb);
  return toUint8Array(bb);
}

function _encodeServerBody(message, bb) {
...
export function decodeServerBody(binary) {
  return _decodeServerBody(wrapByteBuffer(binary));
}

function _decodeServerBody(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string cid = 6;
      case 6: {
        message.cid = readString(bb, readVarint32(bb));
        break;
      }
      ...
      // optional string toId = 9;
      case 9: {
        message.toId = readString(bb, readVarint32(bb));
        break;
      }

      // optional string gid = 10;
      case 10: {
        message.gid = readString(bb, readVarint32(bb));
        break;
      }
...
function _encodeServerMessage(message, bb) {
  ...
  let array$body = message.body;
  if (array$body !== undefined) {
    for (let value of array$body) {
      writeVarint32(bb, 42);
      let nested = popByteBuffer();
      _encodeServerBody(value, nested);
...
function _decodeServerMessage(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string biz = 2;
      case 2: {
        message.biz = readString(bb, readVarint32(bb));
        break;
      }
      ...
      case 5: {
        ...
        let values = message.body || (message.body = []);
        values.push(_decodeServerBody(bb));
        bb.limit = limit;
        break;
      }
